...
function devolverPrimerElemento(array) {
  ...
  function agregarItemAlComienzoDelArray(array, elemento) {
    ...
    // Tu código: // shist quita al principio del arreglo / unshit= esto coloca al comienzo del arreglo
  ...
  function agregarNumeros(numeros) {
    ...
    return sum;
  } //return numeros.reduce(funtion (suma,el) {return acc+ el})
